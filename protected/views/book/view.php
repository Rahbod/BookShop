        ...
        <div class="container">
            ...
            <div class="page-info"><?php
                if ($model->getPerson('نویسنده')):?>
                    <div>نویسنده<?= $model->getPersonsTags('نویسنده') ?></div><?php
                endif;
                ?><?php
                if ($model->getPerson('مترجم')):?>
                    <div>مترجم<?= $model->getPersonsTags('مترجم') ?></div><?php
                endif;
                ?>
                <div>
                    ناشر<a href="<?php echo $this->createUrl('/book/publisher/' . $model->publisher_id . '/' . urlencode($model->getPublisherName())); ?>"
                ...
                <div class="row">
                    <?php if (!empty($model->icon) and is_file(Yii::getPathOfAlias("webroot") . '/uploads/books/icons/' . $model->icon)): ?>
                        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 thumb">
                            <img src="<?= Yii::app()->baseUrl . '/uploads/books/icons/' . $model->icon ?>"
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12 book-info">
                        <div class="info">
                            <h4><?= CHtml::encode($model->title) ?>
                                <small>
                                    <span>ویرایش: <?php echo CHtml::encode($this->parseNumbers($model->lastPackage->version)); ?></span><span>سال چاپ: <?php echo CHtml::encode($this->parseNumbers($model->lastPackage->print_year)); ?></span>
                                </small>
                            </h4>
                            <div class="book-meta">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        ...
                                        <div class="meta-body">تعداد صفحات
                                            <div class="meta-heading"><?= CHtml::encode(Controller::parseNumbers(number_format($model->number_of_pages))) ?>
                                                صفحه
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        ...
                                        <div class="meta-body ltr text-right">تاریخ انتشار
                                            <div class="meta-heading"><?= ($model->lastPackage->publish_date) ? CHtml::encode(JalaliDate::date('d F Y', $model->lastPackage->publish_date)) : 'منتشر نشده'; ?></div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="pull-right"><i class="file-icon"></i></div>
                                        <div class="meta-body">نوع فایل
                                            <div class="meta-heading"><?= $model->lastPackage->getUploadedFilesType(); ?></div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="pull-right"><i class="download-icon"></i></div>
                                        <div class="meta-body">حجم فایل
                                            <div class="meta-heading file-size"><?= $this->parseNumbers($model->lastPackage->getUploadedFilesSize()); ?></div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="pull-right"><i class="earth-icon"></i></div>
                                        <div class="meta-body">زبان
                                            <div class="meta-heading"><?= CHtml::encode($model->language) ?></div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="pull-right"><i class="isbn-icon"></i></div>
                                        <div class="meta-body">شابک
                                            <div class="meta-heading"><?= CHtml::encode($model->lastPackage->isbn) ?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="rating-container">
                                <?php if (!Yii::app()->user->isGuest): ?>
                                    ...
                                    <?= CHtml::ajaxLink('', array('/book/bookmark'), array(
                                        ...
                                        <svg id="bookmark" class="svg svg-bookmark gray"><use
                                                    xlink:href="<?php echo ($bookmarked) ? '#bookmarked' : '#add-to-bookmark'; ?>"></use></svg>
                                        <svg id="remove" class="svg svg-bookmark gray"><use
                                                    xlink:href="#remove-bookmark"></use></svg>
                                        <script>
                                            $(function () {
                                ...
                                <div class="stars">
                                    ...
                                    <span>(<?= CHtml::encode(Controller::parseNumbers($model->getCountRate())) ?>
                                        کاربر)</span>
                                </div>
                                ...
                                <?php if ($model->hasDiscount()): ?>
                                    ...
                                    <h5 class="price">
                                        ...
                                        <?php if ($model->lastPackage->sale_printed): ?>
                                            <small>
                                                / <?= CHtml::encode('نسخه چاپی ' . Controller::parseNumbers(number_format($model->off_printed_price)) . ' تومان') ?></small>
                                        <?php endif; ?>
                                    </h5>
                                <?php else: ?>
                                    <h5 class="price">
                                        ...
                                        <?php if ($model->lastPackage->sale_printed): ?>
                                            <small>
                                                / <?= CHtml::encode('نسخه چاپی ' . Controller::parseNumbers(number_format($model->printed_price)) . ' تومان') ?></small>
                                        <?php endif; ?>
                                    </h5>
                                <? endif; ?>
                                <!-- Price Show End-->
                                ...
                                <div class="small-info">
                                    <p>دسته بندی: <span><a
                                                    href="<?= $this->createUrl('/category/' . $model->category_id . '/' . urldecode($model->category->title)) ?>"><?= CHtml::encode($model->category->title) ?></a></span>
                                    </p>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 book-tabs">
                        <ul class="nav nav-tabs">
                            ...
                            <li><a data-toggle="tab" href="#comments">نظرات
                                    (<?= CHtml::encode(Controller::parseNumbers($model->getCountComments())) ?>)</a>
                            </li>
                        </ul>
                        <div class="tab-content">
                            <div id="summary"
                                 class="tab-pane fade in active"><?php echo $purifier->purify($model->description); ?></div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <ul class="social-list list-inline">
                            <li>
                                <a href="https://www.facebook.com/sharer/sharer.php?u=<?= $this->createAbsoluteUrl('/book/' . $model->id . '/' . urlencode($model->title)) ?>"
                                   class="social-icon"><i class="facebook-icon"></i></a></li>
                            <li>
                                <a href="https://twitter.com/home?status=<?= $this->createAbsoluteUrl('/book/' . $model->id . '/' . urlencode($model->title)) ?>"
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="similar-books">
                                <div class="heading">
                                    ...
                                    <div class="is-carousel" data-item-selector="thumbnail-container"
                                         data-mouse-drag="1"
                                         data-responsive='{"1024":{"items":"3"},"992":{"items":"2"},"710":{"items":"3"},"520":{"items":"2"},"0":{"items":"1","dots":true, "nav":false}}'
                                         data-dots="1" data-nav="0">
                                        <?php
