<nav class="navbar navbar-default">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?= Yii::app()->baseUrl ?>"><img src="<?php echo Yii::app()->theme->baseUrl.'/svg/logo.svg';?>" alt="<?php echo Yii::app()->name;?>"><h1>کــــــتابرســــــــان<small>نزدیکترین کتابفروشی شهر</small></h1></a>
        </div>
